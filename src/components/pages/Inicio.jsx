        ...
        <section className={style.area_inicio}>
            ...
            <div className={style.area_destaque}>
                ...
                <div className={style.propriedades}>
                    <CardCasa area={Casas[0].area} banhos={Casas[0].banhos} comprar={Casas[0].compra} quartos={Casas[0].quartos} categoria={Casas[0].categoria} localizacao={Casas[0].local} nome={Casas[0].nome} preco={Casas[0].preco} mens={Casas[0].mensWhatSapp} srcCasa={Casas[0].srcCasa} />
                    <CardCasa area={Casas[2].area} banhos={Casas[2].banhos} comprar={Casas[2].compra} quartos={Casas[2].quartos} categoria={Casas[2].categoria} localizacao={Casas[2].local} nome={Casas[2].nome} preco={Casas[2].preco} mens={Casas[2].mensWhatSapp} srcCasa={Casas[2].srcCasa} />
                    <CardCasa area={Casas[1].area} banhos={Casas[1].banhos} comprar={Casas[1].compra} quartos={Casas[1].quartos} categoria={Casas[1].categoria} localizacao={Casas[1].local} nome={Casas[1].nome} preco={Casas[1].preco} mens={Casas[1].mensWhatSapp} srcCasa={Casas[1].srcCasa} />
                </div>
            </div>
